...
pieceSvg : List (Svg msg) -> List (Svg.Attribute msg) -> Float -> Float -> Svg msg
pieceSvg children attrs left top =
    let
        allAttrs =
            [ viewBox "0 0 45 45"
            , height (toString pieceSize)
            , width (toString pieceSize)
            , x <| toString <| (left - (pieceSize / 2))
            , y <| toString <| (top - (pieceSize / 2))
            ]
                ++ attrs
    in
...
blackQueen : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
blackQueen =
    pieceSvg
...
whiteKing : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
whiteKing =
    pieceSvg
...
blackRook : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
blackRook =
    pieceSvg
        [ g [ style "opacity:1; fill:000000; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" ]
...
blackBishop : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
blackBishop =
    pieceSvg
...
blackKnight : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
blackKnight =
    pieceSvg
...
blackPawn : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
blackPawn =
    pieceSvg
...
whiteQueen : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
whiteQueen =
    pieceSvg
...
whiteRook : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
whiteRook =
    pieceSvg
        [ g [ style "opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" ]
            [ path [ d "M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z ", style "stroke-linecap:butt;" ]
...
whiteBishop : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
whiteBishop =
    pieceSvg
        [ g [ style "opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" ]
...
whiteKnight : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
whiteKnight =
    pieceSvg
        [ g [ style "opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" ]
...
whitePawn : List (Svg.Attribute msg) -> Float -> Float -> Svg msg
whitePawn =
    pieceSvg
